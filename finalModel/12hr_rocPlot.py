...
# ------------------------------------------------------------------------------
with open("../rocResults/12hr_AllFeatures_Estimators.txt", "rb") as fp:   # Unpickling
    AllFeatures_Estimators = pickle.load(fp)
with open("../rocResults/12hr_AllFeatures_AUC.txt", "rb") as fp:   # Unpickling
    AllFeatures_AUC = pickle.load(fp)
with open("../rocResults/12hr_AllFeatures_FPR.txt", "rb") as fp:   # Unpickling
    AllFeatures_FPR = pickle.load(fp)
with open("../rocResults/12hr_AllFeatures_TPR.txt", "rb") as fp:   # Unpickling
    AllFeatures_TPR = pickle.load(fp)

with open("../rocResults/12hr_BestFeatures_Estimators.txt", "rb") as fp:   # Unpickling
    BestFeatures_Estimators = pickle.load(fp)
with open("../rocResults/12hr_BestFeatures_AUC.txt", "rb") as fp:   # Unpickling
    BestFeatures_AUC = pickle.load(fp)
with open("../rocResults/12hr_BestFeatures_FPR.txt", "rb") as fp:   # Unpickling
    BestFeatures_FPR = pickle.load(fp)
with open("../rocResults/12hr_BestFeatures_TPR.txt", "rb") as fp:   # Unpickling
    BestFeatures_TPR = pickle.load(fp)

with open("../rocResults/12hr_BestEqualFeatures_Estimators.txt", "rb") as fp:   # Unpickling
    BestEqualFeatures_Estimators = pickle.load(fp)
with open("../rocResults/12hr_BestEqualFeatures_AUC.txt", "rb") as fp:   # Unpickling
    BestEqualFeatures_AUC = pickle.load(fp)
with open("../rocResults/12hr_BestEqualFeatures_FPR.txt", "rb") as fp:   # Unpickling
    BestEqualFeatures_FPR = pickle.load(fp)
with open("../rocResults/12hr_BestEqualFeatures_TPR.txt", "rb") as fp:   # Unpickling
